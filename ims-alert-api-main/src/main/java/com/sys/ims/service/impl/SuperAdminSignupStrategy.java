...
/**
 * Represents the SuperAdminSignupStrategy class in the ims-alert-api-main project.
 *
 * @author Kashan Asim
 * @version 1.0
 * @project ims-alert-api-main
 * @module com.sys.ims.service.impl
 * @class SuperAdminSignupStrategy
 ...
 */
@Service
public class SuperAdminSignupStrategy implements SignupStrategy {
    ...
    public void signup(SignupRequest request, NUser creator) throws BaseException {
        if (creator != null) {
            throw new AccessDeniedException("SuperAdmin can only be created manually or during system init");
        }
        ...
        NUser newUser = NUser.builder()
                ...
                .roles(Set.of(roleRepository.findByName("SUPER_ADMIN").orElseThrow()))
